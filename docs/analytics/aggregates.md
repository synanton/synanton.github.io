...
!!! info "Content pending"
    ...
    the documentation plan's **§40, Phase 2** and will follow the standard architecture page
...
How aggregates are computed and protected against side-channel disclosure.
