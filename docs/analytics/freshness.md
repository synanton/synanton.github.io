...
!!! info "Content pending"
    ...
    the documentation plan's **§46, Phase 2** and will follow the standard architecture page
...
Freshness classes -- real-time, near-real-time, hourly, daily -- as part of the metric contract.
