...
!!! info "Content pending"
    ...
    the documentation plan's **§42, Phase 2** and will follow the standard architecture page
...
Analytics storage as a replaceable implementation detail behind the Analytics Storage Contract -- ClickHouse is an implementation choice, not an architectural dependency.
