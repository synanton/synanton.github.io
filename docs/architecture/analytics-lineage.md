...
!!! info "Content pending"
    ...
    the documentation plan's **§38, Phase 2** and will follow the standard architecture page
...
The canonical lineage chain from Source through ECM Element, Chunk, Annotation, Processing Run, Knowledge Projection, Analytical Event, Fact, Aggregate, Metric, Report.
