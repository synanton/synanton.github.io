...
!!! info "Content pending"
    ...
    the documentation plan's **§39-41, Phase 2** and will follow the standard architecture page
...
Why analytics follows the same security model as knowledge, and how aggregate side-channel protection prevents aggregates from leaking what individual records can't.

**Go further:** See Design 1.25.
