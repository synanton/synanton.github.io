...
!!! info "Content pending"
    ...
    the documentation plan's **§70, Phase 6** and will follow the standard architecture page
...
How ingestion, annotation, search and analytics workloads scale independently, and how Equalix prevents background maintenance from starving interactive workloads.
