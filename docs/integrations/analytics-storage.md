...
!!! info "Content pending"
    ...
    the documentation plan's **§42 / §69, Phase 4** and will follow the standard architecture page
...
The Analytics Storage Contract -- the analytical event stream remains the authoritative replay source regardless of which columnar store implements it.
