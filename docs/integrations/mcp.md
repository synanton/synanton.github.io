...
!!! info "Content pending"
    ...
    the documentation plan's **§58 / §69, Phase 4** and will follow the standard architecture page
...
MCP as an integration/access interface for knowledge search, annotation inspection, provenance and analytics.
