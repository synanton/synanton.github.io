...
- :material-compass-outline: **Впервые знакомитесь с Synanton?**
...
- :material-lightbulb-on-outline: **Нужна архитектурная история?**
...
- :material-office-building-outline: **Оцениваете платформу для конкретного сценария?**
...
- :material-file-tree-outline: **Разрабатываете или эксплуатируете платформу?**
