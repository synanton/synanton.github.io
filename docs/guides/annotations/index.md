...
!!! info "Content pending"
    ...
    the documentation plan's **§68, Phase 5** and will follow the standard architecture page
...
Task guides: create tags/classifications/entities/custom annotations, use dictionaries and LLMs, define dependencies, inspect provenance.
