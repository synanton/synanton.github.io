...
!!! info "Content pending"
    ...
    the documentation plan's **§69, Phase 4** and will follow the standard architecture page
...
How-to guides for connecting the Content Extractor, MCP, LLM providers, object storage, search engines, vector databases, graph databases and analytics storage.
