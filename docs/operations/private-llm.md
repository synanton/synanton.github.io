...
!!! info "Content pending"
    ...
    the documentation plan's **§65 / §72, Phase 6** and will follow the standard architecture page
...
Running annotation and enrichment against a private or on-premises LLM instead of an external provider.
